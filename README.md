...
python src/generate.py --data_dir data/processed --method transformer --model_path checkpoints/transformer_best.pt --out outputs/transformer_final.mid --max_new_tokens 1500 --prompt_len 128 --temperature 0.8 --top_k 30
